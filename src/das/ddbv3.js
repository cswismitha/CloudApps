...
const tableName = config.ddb.tablename; // Replace with your table name
...
// Update an item
async function updateItem(key, updateExpression, expressionAttributeValues, returnValues = "ALL_NEW") {
  const params = {
    TableName: tableName,
    Key: marshall(key),
...
async function queryDynamoDBByPartitionKey(partitionKeyValue) {
  const params = {
      TableName: tableName,
